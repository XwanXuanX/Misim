...
* 
 * @file   loader.hpp
 * @brief  Simple loader for loading .bin executable into memory.
 * 
 * @author Yetong Li
 * @date   September 2023
 * 
 * @detail
 * 
 * Simple prototype of a loader that parse the .bin file generated by
 * own assembler, as well as load data and instruction into memory.
 * 
 * For simplifying testing - NOT for professional use!
 * 
 *********************************************************************/
